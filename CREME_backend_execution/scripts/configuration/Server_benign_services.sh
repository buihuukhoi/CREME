...
expect "*:~# "
send "scp -r $controller_user@$controller_ip:$controller_path/Creme/scripts/configuration/prepared_files/benign_server/* $folder\r"
expect "*continue connecting (yes/no*)? "
send "yes\r"
expect " password: "
...
send "rm ~/.ssh/known_hosts\r"
expect "*:~# "
send "scp certificates $controller_user@$controller_ip:$controller_path/Creme/scripts/configuration/prepared_files/benign_client/ConfigureFiles/certificates_$ip\r"
expect "*continue connecting (yes/no*)? "
send "yes\r"
expect " password: "
send "$controller_pass\r"
